...
function getGarmentIcon(type) {
    ...
    if (t.includes('casaca') || t.includes('bomber') || t.includes('abrigo')) return 'ph-coat';
    ...
    if (t.includes('crop')) return 'ph-scissors';
...
function renderStockGrid() {
    console.log("--- RENDERING STOCK GRID (DEBUG V1) ---");
        ...
        <div class="stock-card animate-slide-down" style="animation-delay: ${delay}s">
            <div class="stock-card-header">
                <div style="display: flex; align-items: center; gap: 10px;">
                    <i class="ph ${iconClass} item-icon"></i>
